# ClickUp MCP Server (YallaSquad Fork)

A Model Context Protocol (MCP) server for integrating ClickUp tasks with AI applications. This server allows AI agents to interact with ClickUp tasks, spaces, lists, and folders through a standardized protocol.

> **Note**: This is a community-maintained fork of the original ClickUp MCP server, kept free and open-source for the YallaSquad team and anyone else who needs it.
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/clickup-mcp-server.git
...
```json
{
  "mcpServers": {
    "clickup": {
      "command": "node",
      "args": ["/FULL/PATH/TO/clickup-mcp-server/build/index.js"],
      "env": {
...
> **Important**: Replace `/FULL/PATH/TO/clickup-mcp-server` with the actual absolute path where you cloned the repository.
...
Original project by [TaazKareem](https://github.com/TaazKareem/clickup-mcp-server)  
Maintained as a free, open-source fork by the community.

---

**Questions?** Open an issue on GitHub or reach out to the YallaSquad team.
Don't forget to replace:

YOUR_GITHUB_USERNAME with your actual GitHub username (appears 3 times)
/FULL/PATH/TO/clickup-mcp-server in the examples with your actual path

Want me to also create a quick setup script for your team members?Skip to content
Navigation Menu
AhmedYoussef98
Squad_clickup-mcp-server
...
Squad_clickup-mcp-server
Public
forked from MCP-Mirror/TaazKareem_clickup-mcp-server
AhmedYoussef98/Squad_clickup-mcp-server
Go to filpastedi don't want the mention of taazkareem at all8:36 AMHere's the updated README with all mentions of TaazKareem removed:
markdown# ClickUp MCP Server (Squad Fork)
